...
Open an issue using the **Bug report** template. Include steps to reproduce, what you expected
vs. what happened, and your environment (browser/OS, or desktop app version).
