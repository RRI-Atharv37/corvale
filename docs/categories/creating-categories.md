...
## Add custom sub-categories under a master

Follow these steps to create a new category for classifying transactions.
...
Your new category appears in the master group and becomes available in the transaction Category picker.

## Naming rules

- Category names must be unique within a master group
- Names cannot be empty
- You cannot create duplicate names for active categories under the same master
