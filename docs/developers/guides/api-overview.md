...
Obtain a token from the auth endpoints documented in [Authentication API](../api/authentication-api.md).
...
Legacy `/income` and `/expense` routes return `Deprecation` and `Link` headers pointing to `/transactions`. Prefer the [Transactions API](../api/transactions-api.md) for all new integrations.
...
- [Categories API](../api/categories-api.md)
- [Categorization Rules API](../api/categorization-rules-api.md)
- [Tags API](../api/tags-api.md)
- [Transaction Templates API](../api/transaction-templates-api.md)
- [Recurring Rules API](../api/recurring-api.md)
- [Import API](../api/import-api.md)
- [Backup and Restore API](../api/backup-restore-api.md)
- [Receipts API](../api/receipts-api.md)
- [Accounts API](../api/accounts-api.md)
- [Reconciliation API](../api/reconciliation-api.md)
- [Exchange Rates API](../api/exchange-rates-api.md)
- [Budgets API](../api/budgets-api.md)
- [Savings Goals API](../api/savings-goals-api.md)
- [Data Migration](./data-migration.md)
- [Saver API](../api/saver-api.md)
- [Pushover API](../api/pushover-api.md)
- [Dashboard API](../api/dashboard-api.md)
- [Reports API](../api/reports-api.md)
- [Notifications API](../api/notifications-api.md)
- [Workspaces API](../api/workspaces-api.md)
- [Forecast API](../api/forecast-api.md)
- [Calendar API](../api/calendar-api.md)
- [Subscriptions API](../api/subscriptions-api.md)
- [Debt Payoff API](../api/debts-api.md)
