/**
 * Client-generated record `_id`s: per the "Identity" architecture decision, every syncable
 * create is assigned a client-side 24-hex ObjectId-shaped id up front, accepted as-is by the
