...
import type { SyncStatus } from '@platform/sync/syncEngine'
...
vi.mock('@platform/sync/useSyncStatus', () => ({
    useSyncStatus: () => syncStatus,
}))
vi.mock('@platform/offline/useOnlineStatus', () => ({
    useOnlineStatus: () => true,
}))
vi.mock('@platform/db/localDbInstance', () => ({
    getLocalDb: vi.fn().mockResolvedValue({}),
}))
vi.mock('@platform/sync/conflicts', () => ({
